...
public class FormatTools {
	 ...
	 // -- Constants - pixel types --
	   ...
	   * performed.
	   */
	  public static void checkPlaneParameters(Reader r, int no,
	  ...
	  public static void checkPlaneNumber(Reader r, int no)
	  ...
	  public static void checkBufferSize(Reader r, int len)
	    throws FormatException
	  {
