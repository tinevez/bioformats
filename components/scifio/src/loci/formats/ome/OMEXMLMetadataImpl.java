...
public class OMEXMLMetadataImpl extends AbstractOMEXMLMetadata {
  ...
  private ome.scifio.Metadata SCIFIOMeta;

  public void setSCIFIOMeta(ome.scifio.Metadata meta) {
    SCIFIOMeta = meta;
  }

  public ome.scifio.Metadata getSCIFIOMeta() {
    return SCIFIOMeta;
  }
    ...
    int plateAcquisitionIndex)
  {
    // Parents: {u'ROI': {u'OME': None}, u'PlateAcquisition': {u'Plate': {u'OME': None}}, u'Plate': {u'OME': None}, u'Image': {u'OME': None}, u'Screen': {u'OME': None}, u'Well': {u'Plate': {u'OME': None}}, u'Dataset': {u'OME': None}, u'Project': {u'OME': None}, u'Reagent': {u'Screen': {u'OME': None}}, u'Plane': {u'Pixels': {u'Image': {u'OME': None}}}, u'Experimenter': {u'OME': None}, u'Annotation': None, u'WellSample': {u'Well': {u'Plate': {u'OME': None}}}, u'Pixels': {u'Image': {u'OME': None}}, u'Channel': {u'Pixels': {u'Image': {u'OME': None}}}}
    // AnnotationRef is a reference
    return root.getPlate(plateIndex)
      .getPlateAcquisition(plateAcquisitionIndex)
  ...
  public int getReagentAnnotationRefCount(int screenIndex, int reagentIndex) {
    // Parents: {u'ROI': {u'OME': None}, u'PlateAcquisition': {u'Plate': {u'OME': None}}, u'Plate': {u'OME': None}, u'Image': {u'OME': None}, u'Screen': {u'OME': None}, u'Well': {u'Plate': {u'OME': None}}, u'Dataset': {u'OME': None}, u'Project': {u'OME': None}, u'Reagent': {u'Screen': {u'OME': None}}, u'Plane': {u'Pixels': {u'Image': {u'OME': None}}}, u'Experimenter': {u'OME': None}, u'Annotation': None, u'WellSample': {u'Well': {u'Plate': {u'OME': None}}}, u'Pixels': {u'Image': {u'OME': None}}, u'Channel': {u'Pixels': {u'Image': {u'OME': None}}}}
    // AnnotationRef is a reference
    return root.getScreen(screenIndex)
      .getReagent(reagentIndex)
      .sizeOfLinkedAnnotationList();
  }
  ...
  public int getPlaneAnnotationRefCount(int imageIndex, int planeIndex) {
    // Parents: {u'ROI': {u'OME': None}, u'PlateAcquisition': {u'Plate': {u'OME': None}}, u'Plate': {u'OME': None}, u'Image': {u'OME': None}, u'Screen': {u'OME': None}, u'Well': {u'Plate': {u'OME': None}}, u'Dataset': {u'OME': None}, u'Project': {u'OME': None}, u'Reagent': {u'Screen': {u'OME': None}}, u'Plane': {u'Pixels': {u'Image': {u'OME': None}}}, u'Experimenter': {u'OME': None}, u'Annotation': None, u'WellSample': {u'Well': {u'Plate': {u'OME': None}}}, u'Pixels': {u'Image': {u'OME': None}}, u'Channel': {u'Pixels': {u'Image': {u'OME': None}}}}
    // AnnotationRef is a reference
    return root.getImage(imageIndex)
      .getPixels()
      .getPlane(planeIndex)
      .sizeOfLinkedAnnotationList();
  }
    ...
    int filterSetIndex)
  {
    // Parents: {u'LightPath': {u'Channel': {u'Pixels': {u'Image': {u'OME': None}}}}, u'FilterSet': {u'Instrument': {u'OME': None}}}
    // EmissionFilterRef is a reference
    return root.getInstrument(instrumentIndex)
      .getFilterSet(filterSetIndex)
      .sizeOfLinkedEmissionFilterList();
  }
  ...
  public String getFileAnnotationBinaryFileFileName(int fileAnnotationIndex) {
    ...
    return root.getStructuredAnnotations()
      .getFileAnnotation(fileAnnotationIndex)
      .getBinaryFile()
      .getFileName();
  }
    ...
    int annotationRefIndex)
  {
    ...
    return root.getStructuredAnnotations()
      .getBooleanAnnotation(booleanAnnotationIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
    ...
    int annotationRefIndex)
  {
    ...
    // AnnotationRef is reference and occurs more than once
    return root.getStructuredAnnotations()
      .getCommentAnnotation(commentAnnotationIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
  ...
  public String getDatasetProjectRef(int datasetIndex, int projectRefIndex) {
    ...
    return root.getDataset(datasetIndex)
      .getLinkedProject(projectRefIndex)
      .getID();
  }
    ...
    int annotationRefIndex)
  {
    ...
    // AnnotationRef is reference and occurs more than once
    return root.getStructuredAnnotations()
      .getDoubleAnnotation(doubleAnnotationIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
    ...
    int annotationRefIndex)
  {
    // Parents: {u'OME': None}
    // AnnotationRef is reference and occurs more than once
    return root.getExperimenter(experimenterIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
    ...
    int filterSetIndex, int emissionFilterRefIndex)
  {
    ...
    return root.getInstrument(instrumentIndex)
      .getFilterSet(filterSetIndex)
      .getLinkedEmissionFilter(emissionFilterRefIndex)
      .getID();
  }
    ...
    int filterSetIndex, int excitationFilterRefIndex)
  {
    ...
    return root.getInstrument(instrumentIndex)
      .getFilterSet(filterSetIndex)
      .getLinkedExcitationFilter(excitationFilterRefIndex)
      .getID();
  }
    ...
    int microbeamManipulationRefIndex)
  {
    ...
    return root.getImage(imageIndex)
      .getLinkedMicrobeamManipulation(microbeamManipulationRefIndex)
      .getID();
  }
    ...
    int lightSourceSettingsIndex)
  {
    ...
    return root.getExperiment(experimentIndex)
      .getMicrobeamManipulation(microbeamManipulationIndex)
      .getLightSourceSettings(lightSourceSettingsIndex)
      .getAttenuation();
  }
    ...
    int annotationRefIndex)
  {
    ...
    // AnnotationRef is reference and occurs more than once
    return root.getStructuredAnnotations()
      .getListAnnotation(listAnnotationIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
    ...
    int annotationRefIndex)
  {
    ...
    // AnnotationRef is reference and occurs more than once
    return root.getStructuredAnnotations()
      .getLongAnnotation(longAnnotationIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
    ...
    int plateAcquisitionIndex, int wellSampleRefIndex)
  {
    ...
    return root.getPlate(plateIndex)
      .getPlateAcquisition(plateAcquisitionIndex)
      .getLinkedWellSample(wellSampleRefIndex)
      .getID();
  }
    ...
    int annotationRefIndex)
  {
    ...
    // AnnotationRef is reference and occurs more than once
    return root.getStructuredAnnotations()
      .getTagAnnotation(tagAnnotationIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
    ...
    int annotationRefIndex)
  {
    ...
    // AnnotationRef is reference and occurs more than once
    return root.getStructuredAnnotations()
      .getTermAnnotation(termAnnotationIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
    ...
    int timestampAnnotationIndex, int annotationRefIndex)
  {
    ...
    // AnnotationRef is reference and occurs more than once
    return root.getStructuredAnnotations()
      .getTimestampAnnotation(timestampAnnotationIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
    ...
    int annotationRefIndex)
  {
    ...
    // AnnotationRef is reference and occurs more than once
    return root.getStructuredAnnotations()
      .getXMLAnnotation(XMLAnnotationIndex)
      .getLinkedAnnotation(annotationRefIndex)
      .getID();
  }
    ...
    int booleanAnnotationIndex, int annotationRefIndex)
  {
    ...
    model.addReference(
      root.getStructuredAnnotations().getBooleanAnnotation(
        booleanAnnotationIndex), annotationList_reference);
  }
    ...
    int commentAnnotationIndex, int annotationRefIndex)
  {
    ...
    annotationList_reference.setID(annotation);
    model.addReference(
      root.getStructuredAnnotations().getCommentAnnotation(
        commentAnnotationIndex), annotationList_reference);
  }
    ...
    int annotationRefIndex)
  {
    ...
    AnnotationRef annotationList_reference = new AnnotationRef();
    annotationList_reference.setID(annotation);
    model.addReference(root.getDataset(datasetIndex), annotationList_reference);
  }
  ...
  public void setDatasetGroupRef(String group, int datasetIndex) {
    ...
    model.addReference(root.getDataset(datasetIndex), group_reference);
  }
    ...
    int projectRefIndex)
  {
    ...
    model.addReference(root.getDataset(datasetIndex), projectList_reference);
  }
    ...
    int doubleAnnotationIndex, int annotationRefIndex)
  {
    ...
    annotationList_reference.setID(annotation);
    model.addReference(
      root.getStructuredAnnotations()
        .getDoubleAnnotation(doubleAnnotationIndex), annotationList_reference);
  }
    ...
    int experimentIndex)
  {
    ...
    experimenter_reference.setID(experimenter);
    model.addReference(
      root.getExperiment(experimentIndex), experimenter_reference);
  }
    ...
    int experimenterIndex, int annotationRefIndex)
  {
    ...
    annotationList_reference.setID(annotation);
    model.addReference(
      root.getExperimenter(experimenterIndex), annotationList_reference);
  }
    ...
    int groupRefIndex)
  {
    ...
    model.addReference(
      root.getExperimenter(experimenterIndex), groupList_reference);
  }
    ...
    int instrumentIndex, int filterSetIndex, int excitationFilterRefIndex)
  {
    // Parents: {u'Instrument': {u'OME': None}}
    // ExcitationFilterRef is reference and occurs more than once
    ExcitationFilterRef excitationFilterList_reference =
  ...
  public void setGroupContact(String contact, int groupIndex) {
    ...
    model.addReference(root.getGroup(groupIndex), contact_reference);
  }
  ...
  public void setGroupLeader(String leader, int groupIndex) {
    ...
    model.addReference(root.getGroup(groupIndex), leader_reference);
  }
    ...
    int annotationRefIndex)
  {
    ...
    AnnotationRef annotationList_reference = new AnnotationRef();
    annotationList_reference.setID(annotation);
    model.addReference(root.getImage(imageIndex), annotationList_reference);
  }
    ...
    int datasetRefIndex)
  {
    ...
    model.addReference(root.getImage(imageIndex), datasetList_reference);
  }
  ...
  public void setImageGroupRef(String group, int imageIndex) {
    ...
    GroupRef group_reference = new GroupRef();
    group_reference.setID(group);
    model.addReference(root.getImage(imageIndex), group_reference);
  }
    ...
    int imageIndex, int microbeamManipulationRefIndex)
  {
    // Parents: {u'OME': None}
    // MicrobeamManipulationRef is reference and occurs more than once
    MicrobeamManipulationRef microbeamManipulationList_reference =
      new MicrobeamManipulationRef();
    microbeamManipulationList_reference.setID(microbeamManipulation);
    model.addReference(
      root.getImage(imageIndex), microbeamManipulationList_reference);
  }
  ...
  public void setImageROIRef(String roi, int imageIndex, int ROIRefIndex) {
    ...
    model.addReference(root.getImage(imageIndex), roiList_reference);
  }
    ...
    int channelIndex)
  {
    ...
    model.addReference(
      root.getImage(imageIndex)
        .getPixels()
        .getChannel(channelIndex)
        .getLightPath(), dichroic_reference);
  }
    ...
    int imageIndex, int channelIndex, int emissionFilterRefIndex)
  {
    ...
    model.addReference(
      root.getImage(imageIndex)
        .getPixels()
        .getChannel(channelIndex)
        .getLightPath(), emissionFilterList_reference);
  }
    ...
    int imageIndex, int channelIndex, int excitationFilterRefIndex)
  {
    ...
    model.addReference(
      root.getImage(imageIndex)
        .getPixels()
        .getChannel(channelIndex)
        .getLightPath(), excitationFilterList_reference);
  }
    ...
    int experimentIndex, int microbeamManipulationIndex)
  {
    ...
    experimenter_reference.setID(experimenter);
    model.addReference(
      root.getExperiment(experimentIndex).getMicrobeamManipulation(
    ...
    int microbeamManipulationIndex, int ROIRefIndex)
  {
    ...
    model.addReference(root.getExperiment(experimentIndex)
      .getMicrobeamManipulation(microbeamManipulationIndex), roiList_reference);
  }
    ...
    int OTFIndex)
  {
    ...
    filterSet_reference.setID(filterSet);
    model.addReference(
      root.getInstrument(instrumentIndex).getOTF(OTFIndex), filterSet_reference);
  }
    ...
    int annotationRefIndex)
  {
    ...
    annotationList_reference.setID(annotation);
    model.addReference(
      root.getImage(imageIndex).getPixels(), annotationList_reference);
  }
    ...
    int annotationRefIndex)
  {
    ...
    AnnotationRef annotationList_reference = new AnnotationRef();
    annotationList_reference.setID(annotation);
    model.addReference(root.getPlate(plateIndex), annotationList_reference);
  }
    ...
    int screenRefIndex)
  {
    ...
    model.addReference(root.getPlate(plateIndex), screenList_reference);
  }
    ...
    int annotationRefIndex)
  {
    ...
    AnnotationRef annotationList_reference = new AnnotationRef();
    annotationList_reference.setID(annotation);
    model.addReference(root.getProject(projectIndex), annotationList_reference);
  }
  ...
  public void setProjectGroupRef(String group, int projectIndex) {
    ...
    GroupRef group_reference = new GroupRef();
    group_reference.setID(group);
    model.addReference(root.getProject(projectIndex), group_reference);
  }
    ...
    int annotationRefIndex)
  {
    ...
    AnnotationRef annotationList_reference = new AnnotationRef();
    annotationList_reference.setID(annotation);
    model.addReference(root.getROI(ROIIndex), annotationList_reference);
  }
    ...
    int annotationRefIndex)
  {
    ...
    AnnotationRef annotationList_reference = new AnnotationRef();
    annotationList_reference.setID(annotation);
    model.addReference(root.getScreen(screenIndex), annotationList_reference);
  }
  ...
  public void setScreenPlateRef(String plate, int screenIndex, int plateRefIndex)
  {
    ...
    model.addReference(root.getScreen(screenIndex), plateList_reference);
  }
    ...
    int timestampAnnotationIndex, int annotationRefIndex)
  {
    ...
    annotationList_reference.setID(annotation);
    model.addReference(
      root.getStructuredAnnotations().getTimestampAnnotation(
        timestampAnnotationIndex), annotationList_reference);
  }
    ...
    int wellIndex, int annotationRefIndex)
  {
    ...
    annotationList_reference.setID(annotation);
    model.addReference(
      root.getPlate(plateIndex).getWell(wellIndex), annotationList_reference);
  }
  ...
  public void setWellReagentRef(String reagent, int plateIndex, int wellIndex) {
    ...
    model.addReference(
      root.getPlate(plateIndex).getWell(wellIndex), reagent_reference);
  }
    ...
    int wellIndex, int wellSampleIndex, int annotationRefIndex)
  {
    ...
    AnnotationRef annotationList_reference = new AnnotationRef();
    annotationList_reference.setID(annotation);
    model.addReference(root.getPlate(plateIndex)
      .getWell(wellIndex)
      .getWellSample(wellSampleIndex), annotationList_reference);
  }
