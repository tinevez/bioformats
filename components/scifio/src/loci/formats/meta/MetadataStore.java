...
public interface MetadataStore {
  ...
  void setSCIFIOMeta(ome.scifio.Metadata meta);

  void setRoot(Object root);

  // -- Entity storage (manual definitions) --

  void setPixelsBinDataBigEndian(Boolean bigEndian, int imageIndex,
    int binDataIndex);
  ...
  void setArcLotNumber(String lotNumber, int instrumentIndex,
    int lightSourceIndex);

  // Manufacturer accessor from parent LightSource
  void setArcManufacturer(String manufacturer, int instrumentIndex,
    int lightSourceIndex);
  ...
  void setArcSerialNumber(String serialNumber, int instrumentIndex,
    int lightSourceIndex);
  ...
  void setFileAnnotationBinaryFileFileName(String fileName,
    int fileAnnotationIndex);

  void setOTFBinaryFileFileName(String fileName, int instrumentIndex,
    int OTFIndex);

  void setFileAnnotationBinaryFileMIMEType(String mimetype,
    int fileAnnotationIndex);

  void setOTFBinaryFileMIMEType(String mimetype, int instrumentIndex,
    int OTFIndex);

  void setFileAnnotationBinaryFileSize(NonNegativeLong size,
    int fileAnnotationIndex);

  void setOTFBinaryFileSize(NonNegativeLong size, int instrumentIndex,
    int OTFIndex);
  ...
  void setBooleanAnnotationAnnotationRef(String annotation,
  ...
  void setBooleanAnnotationDescription(String description,
  ...
  void setBooleanAnnotationNamespace(String namespace,
    int booleanAnnotationIndex);
  ...
  void setChannelAcquisitionMode(AcquisitionMode acquisitionMode,
    int imageIndex, int channelIndex);

  void setChannelAnnotationRef(String annotation, int imageIndex,
    int channelIndex, int annotationRefIndex);

  void setChannelColor(Integer color, int imageIndex, int channelIndex);

  void setChannelContrastMethod(ContrastMethod contrastMethod, int imageIndex,
    int channelIndex);

  // Ignoring DetectorSettings element, complex property
  void setChannelEmissionWavelength(PositiveInteger emissionWavelength,
    int imageIndex, int channelIndex);

  void setChannelExcitationWavelength(PositiveInteger excitationWavelength,
    int imageIndex, int channelIndex);
  ...
  void setChannelIlluminationType(IlluminationType illuminationType,
    int imageIndex, int channelIndex);
  ...
  void setChannelPinholeSize(Double pinholeSize, int imageIndex,
    int channelIndex);

  void setChannelPockelCellSetting(Integer pockelCellSetting, int imageIndex,
    int channelIndex);

  void setChannelSamplesPerPixel(PositiveInteger samplesPerPixel,
    int imageIndex, int channelIndex);
  ...
  void setCommentAnnotationAnnotationRef(String annotation,
    int commentAnnotationIndex, int annotationRefIndex);

  // Ignoring Channel_BackReference back reference
  // Ignoring Dataset_BackReference back reference
  void setCommentAnnotationDescription(String description,
  ...
  // Ignoring Image_BackReference back reference
  void setCommentAnnotationNamespace(String namespace,
    int commentAnnotationIndex);
  ...
  void setDatasetProjectRef(String project, int datasetIndex,
    int projectRefIndex);
  ...
  void setDetectorAmplificationGain(Double amplificationGain,
  ...
  void setDetectorLotNumber(String lotNumber, int instrumentIndex,
    int detectorIndex);

  void setDetectorManufacturer(String manufacturer, int instrumentIndex,
    int detectorIndex);
  ...
  void setDetectorSerialNumber(String serialNumber, int instrumentIndex,
    int detectorIndex);
  ...
  void setDetectorSettingsBinning(Binning binning, int imageIndex,
    int channelIndex);
  ...
  void setDetectorSettingsReadOutRate(Double readOutRate, int imageIndex,
    int channelIndex);

  void setDetectorSettingsVoltage(Double voltage, int imageIndex,
    int channelIndex);
  ...
  void setDichroicLotNumber(String lotNumber, int instrumentIndex,
    int dichroicIndex);

  void setDichroicManufacturer(String manufacturer, int instrumentIndex,
    int dichroicIndex);

  void setDichroicModel(String model, int instrumentIndex, int dichroicIndex);

  void setDichroicSerialNumber(String serialNumber, int instrumentIndex,
    int dichroicIndex);
  ...
  void setDoubleAnnotationAnnotationRef(String annotation,
    int doubleAnnotationIndex, int annotationRefIndex);

  // Ignoring Channel_BackReference back reference
  // Ignoring Dataset_BackReference back reference
  void setDoubleAnnotationDescription(String description,
  ...
  void setEllipseFontSize(NonNegativeInteger fontSize, int ROIIndex,
    int shapeIndex);
  ...
  void setEllipseStrokeDashArray(String strokeDashArray, int ROIIndex,
    int shapeIndex);
  ...
  void setExperimenterAnnotationRef(String annotation, int experimenterIndex,
    int annotationRefIndex);
  ...
  void setExperimenterGroupRef(String group, int experimenterIndex,
    int groupRefIndex);
  ...
  // Ignoring LightEmittingDiode of parent abstract type
  // LotNumber accessor from parent LightSource
  void setFilamentLotNumber(String lotNumber, int instrumentIndex,
    int lightSourceIndex);

  // Manufacturer accessor from parent LightSource
  void setFilamentManufacturer(String manufacturer, int instrumentIndex,
    int lightSourceIndex);
  ...
  // SerialNumber accessor from parent LightSource
  void setFilamentSerialNumber(String serialNumber, int instrumentIndex,
    int lightSourceIndex);

  void setFilamentType(FilamentType type, int instrumentIndex,
    int lightSourceIndex);
  ...
  void setFileAnnotationAnnotationRef(String annotation,
  ...
  // Ignoring FilterSet_BackReference back reference
  void setFilterFilterWheel(String filterWheel, int instrumentIndex,
    int filterIndex);
  ...
  void setFilterManufacturer(String manufacturer, int instrumentIndex,
    int filterIndex);

  void setFilterModel(String model, int instrumentIndex, int filterIndex);

  void setFilterSerialNumber(String serialNumber, int instrumentIndex,
    int filterIndex);
  ...
  // Ignoring Channel_BackReference back reference
  void setFilterSetDichroicRef(String dichroic, int instrumentIndex,
    int filterSetIndex);

  void setFilterSetEmissionFilterRef(String emissionFilter,
    int instrumentIndex, int filterSetIndex, int emissionFilterRefIndex);

  void setFilterSetExcitationFilterRef(String excitationFilter,
  ...
  void setFilterSetLotNumber(String lotNumber, int instrumentIndex,
    int filterSetIndex);

  void setFilterSetManufacturer(String manufacturer, int instrumentIndex,
    int filterSetIndex);

  void setFilterSetModel(String model, int instrumentIndex, int filterSetIndex);

  // Ignoring OTF_BackReference back reference
  void setFilterSetSerialNumber(String serialNumber, int instrumentIndex,
    int filterSetIndex);
  ...
  void setImageAnnotationRef(String annotation, int imageIndex,
    int annotationRefIndex);
  ...
  void setImageMicrobeamManipulationRef(String microbeamManipulation,
  ...
  void setImagingEnvironmentCO2Percent(PercentFraction co2percent,
    int imageIndex);
  ...
  // Ignoring LightEmittingDiode of parent abstract type
  // LotNumber accessor from parent LightSource
  void setLaserLotNumber(String lotNumber, int instrumentIndex,
    int lightSourceIndex);

  // Manufacturer accessor from parent LightSource
  void setLaserManufacturer(String manufacturer, int instrumentIndex,
    int lightSourceIndex);
  ...
  // SerialNumber accessor from parent LightSource
  void setLaserSerialNumber(String serialNumber, int instrumentIndex,
    int lightSourceIndex);

  void setLaserFrequencyMultiplication(PositiveInteger frequencyMultiplication,
    int instrumentIndex, int lightSourceIndex);

  void setLaserLaserMedium(LaserMedium laserMedium, int instrumentIndex,
    int lightSourceIndex);

  void setLaserPockelCell(Boolean pockelCell, int instrumentIndex,
    int lightSourceIndex);
  ...
  void setLaserRepetitionRate(Double repetitionRate, int instrumentIndex,
    int lightSourceIndex);

  void setLaserTuneable(Boolean tuneable, int instrumentIndex,
    int lightSourceIndex);

  void setLaserType(LaserType type, int instrumentIndex, int lightSourceIndex);

  void setLaserWavelength(PositiveInteger wavelength, int instrumentIndex,
    int lightSourceIndex);
  ...
  // Ignoring Filament of parent abstract type
  // ID accessor from parent LightSource
  void setLightEmittingDiodeID(String id, int instrumentIndex,
    int lightSourceIndex);

  // Ignoring Laser of parent abstract type
  // Ignoring LightEmittingDiode of parent abstract type
  // LotNumber accessor from parent LightSource
  void setLightEmittingDiodeLotNumber(String lotNumber, int instrumentIndex,
    int lightSourceIndex);

  // Manufacturer accessor from parent LightSource
  void setLightEmittingDiodeManufacturer(String manufacturer,
    int instrumentIndex, int lightSourceIndex);

  // Model accessor from parent LightSource
  void setLightEmittingDiodeModel(String model, int instrumentIndex,
    int lightSourceIndex);

  // Power accessor from parent LightSource
  void setLightEmittingDiodePower(Double power, int instrumentIndex,
    int lightSourceIndex);

  // SerialNumber accessor from parent LightSource
  void setLightEmittingDiodeSerialNumber(String serialNumber,
    int instrumentIndex, int lightSourceIndex);
  ...
  void setLightPathEmissionFilterRef(String emissionFilter, int imageIndex,
    int channelIndex, int emissionFilterRefIndex);

  void setLightPathExcitationFilterRef(String excitationFilter, int imageIndex,
  ...
  void setChannelLightSourceSettingsAttenuation(PercentFraction attenuation,
    int imageIndex, int channelIndex);

  void setMicrobeamManipulationLightSourceSettingsAttenuation(
    PercentFraction attenuation, int experimentIndex,
    int microbeamManipulationIndex, int lightSourceSettingsIndex);

  void setChannelLightSourceSettingsID(String id, int imageIndex,
    int channelIndex);

  void setMicrobeamManipulationLightSourceSettingsID(String id,
    int experimentIndex, int microbeamManipulationIndex,
    int lightSourceSettingsIndex);

  void setChannelLightSourceSettingsWavelength(PositiveInteger wavelength,
    int imageIndex, int channelIndex);
  ...
  // StrokeDashArray accessor from parent Shape
  void setLineStrokeDashArray(String strokeDashArray, int ROIIndex,
    int shapeIndex);
  ...
  void setListAnnotationAnnotationRef(String annotation,
  ...
  void setLongAnnotationAnnotationRef(String annotation,
  ...
  // StrokeDashArray accessor from parent Shape
  void setMaskStrokeDashArray(String strokeDashArray, int ROIIndex,
    int shapeIndex);
  ...
  void setMicrobeamManipulationDescription(String description,
    int experimentIndex, int microbeamManipulationIndex);

  void setMicrobeamManipulationExperimenterRef(String experimenter,
    int experimentIndex, int microbeamManipulationIndex);

  void setMicrobeamManipulationID(String id, int experimentIndex,
    int microbeamManipulationIndex);

  // Ignoring Image_BackReference back reference
  // Ignoring LightSourceSettings element, complex property
  void setMicrobeamManipulationROIRef(String roi, int experimentIndex,
    int microbeamManipulationIndex, int ROIRefIndex);

  void setMicrobeamManipulationType(MicrobeamManipulationType type,
    int experimentIndex, int microbeamManipulationIndex);
  ...
  // Ignoring ObjectiveSettings element, complex property
  void setOTFOpticalAxisAveraged(Boolean opticalAxisAveraged,
  ...
  void setObjectiveCalibratedMagnification(Double calibratedMagnification,
    int instrumentIndex, int objectiveIndex);

  void setObjectiveCorrection(Correction correction, int instrumentIndex,
    int objectiveIndex);

  void setObjectiveID(String id, int instrumentIndex, int objectiveIndex);

  void setObjectiveImmersion(Immersion immersion, int instrumentIndex,
    int objectiveIndex);
  ...
  void setObjectiveLotNumber(String lotNumber, int instrumentIndex,
    int objectiveIndex);

  void setObjectiveManufacturer(String manufacturer, int instrumentIndex,
    int objectiveIndex);

  void setObjectiveModel(String model, int instrumentIndex, int objectiveIndex);

  void setObjectiveNominalMagnification(PositiveInteger nominalMagnification,
    int instrumentIndex, int objectiveIndex);

  void setObjectiveSerialNumber(String serialNumber, int instrumentIndex,
    int objectiveIndex);

  void setObjectiveWorkingDistance(Double workingDistance, int instrumentIndex,
    int objectiveIndex);
  ...
  void setImageObjectiveSettingsCorrectionCollar(Double correctionCollar,
    int imageIndex);

  void setOTFObjectiveSettingsCorrectionCollar(Double correctionCollar,
    int instrumentIndex, int OTFIndex);
  ...
  void setOTFObjectiveSettingsMedium(Medium medium, int instrumentIndex,
    int OTFIndex);

  void setImageObjectiveSettingsRefractiveIndex(Double refractiveIndex,
    int imageIndex);

  void setOTFObjectiveSettingsRefractiveIndex(Double refractiveIndex,
    int instrumentIndex, int OTFIndex);
  ...
  // StrokeDashArray accessor from parent Shape
  void setPathStrokeDashArray(String strokeDashArray, int ROIIndex,
    int shapeIndex);
  ...
  void setPixelsAnnotationRef(String annotation, int imageIndex,
    int annotationRefIndex);
  ...
  void setPlaneAnnotationRef(String annotation, int imageIndex, int planeIndex,
    int annotationRefIndex);
  ...
  void setPlateAnnotationRef(String annotation, int plateIndex,
    int annotationRefIndex);

  void setPlateColumnNamingConvention(NamingConvention columnNamingConvention,
    int plateIndex);
  ...
  void setPlateRowNamingConvention(NamingConvention rowNamingConvention,
    int plateIndex);
  ...
  void setPlateAcquisitionAnnotationRef(String annotation, int plateIndex,
    int plateAcquisitionIndex, int annotationRefIndex);

  void setPlateAcquisitionDescription(String description, int plateIndex,
    int plateAcquisitionIndex);

  void setPlateAcquisitionEndTime(String endTime, int plateIndex,
    int plateAcquisitionIndex);

  void setPlateAcquisitionID(String id, int plateIndex,
    int plateAcquisitionIndex);

  void setPlateAcquisitionMaximumFieldCount(PositiveInteger maximumFieldCount,
    int plateIndex, int plateAcquisitionIndex);

  void setPlateAcquisitionName(String name, int plateIndex,
    int plateAcquisitionIndex);

  void setPlateAcquisitionStartTime(String startTime, int plateIndex,
    int plateAcquisitionIndex);

  void setPlateAcquisitionWellSampleRef(String wellSample, int plateIndex,
  ...
  // Ignoring FontFamily of parent abstract type
  // FontSize accessor from parent Shape
  void setPointFontSize(NonNegativeInteger fontSize, int ROIIndex,
    int shapeIndex);
  ...
  // StrokeDashArray accessor from parent Shape
  void setPointStrokeDashArray(String strokeDashArray, int ROIIndex,
    int shapeIndex);
  ...
  // Ignoring FontFamily of parent abstract type
  // FontSize accessor from parent Shape
  void setPolylineFontSize(NonNegativeInteger fontSize, int ROIIndex,
    int shapeIndex);
  ...
  // StrokeDashArray accessor from parent Shape
  void setPolylineStrokeDashArray(String strokeDashArray, int ROIIndex,
    int shapeIndex);
  ...
  void setProjectAnnotationRef(String annotation, int projectIndex,
    int annotationRefIndex);
  ...
  void setROIAnnotationRef(String annotation, int ROIIndex,
    int annotationRefIndex);
  ...
  void setReagentAnnotationRef(String annotation, int screenIndex,
    int reagentIndex, int annotationRefIndex);

  void setReagentDescription(String description, int screenIndex,
    int reagentIndex);
  ...
  void setReagentReagentIdentifier(String reagentIdentifier, int screenIndex,
    int reagentIndex);
  ...
  // Ignoring FontFamily of parent abstract type
  // FontSize accessor from parent Shape
  void setRectangleFontSize(NonNegativeInteger fontSize, int ROIIndex,
    int shapeIndex);
  ...
  // StrokeDashArray accessor from parent Shape
  void setRectangleStrokeDashArray(String strokeDashArray, int ROIIndex,
    int shapeIndex);
  ...
  void setScreenAnnotationRef(String annotation, int screenIndex,
    int annotationRefIndex);
  ...
  void setScreenReagentSetDescription(String reagentSetDescription,
    int screenIndex);
  ...
  void setTagAnnotationAnnotationRef(String annotation, int tagAnnotationIndex,
    int annotationRefIndex);
  ...
  void setTermAnnotationAnnotationRef(String annotation,
  ...
  // StrokeDashArray accessor from parent Shape
  void setTextStrokeDashArray(String strokeDashArray, int ROIIndex,
    int shapeIndex);
  ...
  void setTiffDataFirstC(NonNegativeInteger firstC, int imageIndex,
    int tiffDataIndex);

  void setTiffDataFirstT(NonNegativeInteger firstT, int imageIndex,
    int tiffDataIndex);

  void setTiffDataFirstZ(NonNegativeInteger firstZ, int imageIndex,
    int tiffDataIndex);

  void setTiffDataIFD(NonNegativeInteger ifd, int imageIndex, int tiffDataIndex);

  void setTiffDataPlaneCount(NonNegativeInteger planeCount, int imageIndex,
    int tiffDataIndex);
  ...
  void setTimestampAnnotationAnnotationRef(String annotation,
    int timestampAnnotationIndex, int annotationRefIndex);

  // Ignoring Channel_BackReference back reference
  // Ignoring Dataset_BackReference back reference
  void setTimestampAnnotationDescription(String description,
  ...
  // Ignoring Image_BackReference back reference
  void setTimestampAnnotationNamespace(String namespace,
    int timestampAnnotationIndex);
  ...
  void setTransmittanceRangeCutIn(PositiveInteger cutIn, int instrumentIndex,
    int filterIndex);

  void setTransmittanceRangeCutInTolerance(NonNegativeInteger cutInTolerance,
    int instrumentIndex, int filterIndex);

  void setTransmittanceRangeCutOut(PositiveInteger cutOut, int instrumentIndex,
    int filterIndex);

  void setTransmittanceRangeCutOutTolerance(NonNegativeInteger cutOutTolerance,
    int instrumentIndex, int filterIndex);

  void setTransmittanceRangeTransmittance(PercentFraction transmittance,
    int instrumentIndex, int filterIndex);
  ...
  void setWellAnnotationRef(String annotation, int plateIndex, int wellIndex,
    int annotationRefIndex);
  ...
  void setWellExternalDescription(String externalDescription, int plateIndex,
    int wellIndex);

  void setWellExternalIdentifier(String externalIdentifier, int plateIndex,
    int wellIndex);
  ...
  void setWellSampleAnnotationRef(String annotation, int plateIndex,
    int wellIndex, int wellSampleIndex, int annotationRefIndex);

  void setWellSampleID(String id, int plateIndex, int wellIndex,
    int wellSampleIndex);

  void setWellSampleImageRef(String image, int plateIndex, int wellIndex,
    int wellSampleIndex);

  void setWellSampleIndex(NonNegativeInteger index, int plateIndex,
    int wellIndex, int wellSampleIndex);

  // Ignoring PlateAcquisition_BackReference back reference
  void setWellSamplePositionX(Double positionX, int plateIndex, int wellIndex,
    int wellSampleIndex);

  void setWellSamplePositionY(Double positionY, int plateIndex, int wellIndex,
    int wellSampleIndex);

  void setWellSampleTimepoint(String timepoint, int plateIndex, int wellIndex,
    int wellSampleIndex);
  ...
  void setXMLAnnotationAnnotationRef(String annotation, int XMLAnnotationIndex,
    int annotationRefIndex);
