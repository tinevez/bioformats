...
public class FilterMetadata implements MetadataStore {
  ...
  {
    strokeDashArray =
      filter ? DataTools.sanitize(strokeDashArray) : strokeDashArray;
    ...
    int instrumentIndex, int filterSetIndex, int emissionFilterRefIndex)
  {
    store.setFilterSetEmissionFilterRef(
      emissionFilter, instrumentIndex, filterSetIndex, emissionFilterRefIndex);
  }
    ...
    int lightSourceSettingsIndex)
  {
    ...
    store.setMicrobeamManipulationLightSourceSettingsID(
      id, experimentIndex, microbeamManipulationIndex, lightSourceSettingsIndex);
  }
  ...
  {
    externalIdentifier =
      filter ? DataTools.sanitize(externalIdentifier) : externalIdentifier;
  ...
  {
    reagentIdentifier =
      filter ? DataTools.sanitize(reagentIdentifier) : reagentIdentifier;
  ...
  {
    protocolDescription =
      filter ? DataTools.sanitize(protocolDescription) : protocolDescription;
  ...
  {
    protocolIdentifier =
      filter ? DataTools.sanitize(protocolIdentifier) : protocolIdentifier;
    ...
    int screenIndex)
  {
    reagentSetDescription =
      filter ? DataTools.sanitize(reagentSetDescription)
        : reagentSetDescription;
    ...
    int screenIndex)
  {
    reagentSetIdentifier =
      filter ? DataTools.sanitize(reagentSetIdentifier) : reagentSetIdentifier;
  ...
  {
    externalDescription =
      filter ? DataTools.sanitize(externalDescription) : externalDescription;
    ...
    int wellIndex, int wellSampleIndex, int annotationRefIndex)
  {
    store.setWellSampleAnnotationRef(
      annotation, plateIndex, wellIndex, wellSampleIndex, annotationRefIndex);
  }
